---
title: 个人使用vpn“翻墙”是否违法
tags: [ "转载","翻墙","vpn","违法行为","技术讨论" ]
author: 王宇扬
published: 2024-06-01
description: "个人使用vpn“翻墙”是否违法  ——基于规范性法律文件、案例以及相关计算机技术的分析与讨论"
category: 转载
draft: false
image: ""
---                                                                                                   
...
<!-- more -->
>免责声明：本人不承担任何法律责任，文章转载自BiliBili （恕我违反原文已标记的“未经允许，不得转载”标识，在本博客转载保存的目的是防止B站、微信删文，实属无奈） **账号已注销** *（恕我不知道B站转载者的真实昵称，伊里奇发现本文时账号便已注销）*  **原文链接https://www.bilibili.com/read/cv20691224/?jump_opus=1**
...
在本文大致框架形成以前，我已查阅**国内几乎所有关于“翻墙”的论文和文章**，大部分探讨都存在着严重的问题，有些是法学常识性问题（或不讨论法律层面的问题），有些是计算机技术方面的常识性问题（常出现在法学类文章中）。
...
2. **法条分析及相关专业名词释义**
	...
	3. 当我们讨论“翻墙行为”究竟是否违法时，我们首先应该讨论么
    4. 翻墙行为是否属于私自架设物理信道？
3. **提供翻墙方法、售卖翻墙服务的违法性**
4. **从计算机技术角度解读** ***——什么是墙，什么是翻墙***
    1. 互联网访问基本原理——OSI参考模型
		1. 国内网站访问原理
	  	2. 境外网站访问原理
	2. GFW的原理
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/MpgDHibvMpokz8YGWSrTX43MkYgkVNGaobZtqVQe8DAgU3olnMhRraZqUm7hicZDbzhEvpTp2ewrWAFYicz5z5NDg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
**c.** 在内容部分，并没有相应的证据材料予以佐证。首先，行政相对人不可能记住自己使用vpn的连接次数，因此该数据不可能从询问笔录中反映出来。
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_jpg/MpgDHibvMpokR1ZW26weXib2E2SbhhhmTEtBHBIBVEwVia4iagWUheTSryNxaWu14T4qAr1so9AAjsHzbBUyJVwAiag/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
>
>**第六条**    计算机信息网络直接进行国际联网，必须使用 ***邮电部国家公用电信网提供的国际出入口信道***。任何单位和个人不得 ***自行建立或者使用其他信道进行国际联网***。
>
...
有很多人一看到	“自行建立或使用”、“国际出入口	信道”就激动地跳了起来，认为其含义和“使用vpn访问境外网站”是同一种意思，但实际上这是一个非常大的误解。
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_jpg/MpgDHibvMpokz8YGWSrTX43MkYgkVNGaovxdIUaPYxurIRwTt6R7yRFWm4eocB3AV9GeYribhdOoTP3RnEZIRSyg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_jpg/MpgDHibvMpokz8YGWSrTX43MkYgkVNGaom5JLZdhwp8icE3ZJat1vgUoiafxics2zSUKIdE6rb0Le0iab3GsyNJY4pg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
进一步，从近期的规范性法律文件来看，与“翻墙”关系最密切的莫过于 ***工业和信息化部关于清理规范互联网网络接入服务市场的通知（工信部信管函[2017]32号）*** 以及 ***工业和信息化部办公厅关于深入推进互联网网络接入服务市场清理规范工作的通知（工信厅信管函〔2018〕161号）。***
...
连通性的问题解决了，还要解决数据包在庞大的“网上公路”迷路的可能性。在上述提到的各个级别的网路中，分布着无数路由节点，每一张骨干网都有自己负责的路由群组和节点，整个群组统称为as自治系统（Autonomous system），每一个骨干网管理的as自治系统都经过名为 ***互联网号码分配局*** 的国际机构分配唯一识别代码	，例如，中国电信163骨干网的as自治系统编号为AS4134。每一张骨干网都有内部路由协议，每一个节点都在依据某种规定互相交换他们所连通的ip地址信息，作为数据包在“旅行”过程中的指路人。而全国性的骨干网之间也依靠外部路由协议互相交换它们所掌握的“服务器地图“，典型的有BGP协议。
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_png/MpgDHibvMpok9ZQI2iayBUvcnibk9eYKvJibMgabVicypabUKYfNaUyfFMicpoH1S0kdPzwxDPiafUWbzibouxQrZTdRWw/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_png/MpgDHibvMpok9ZQI2iayBUvcnibk9eYKvJibnzCU1OUtNO2KCSNgJ7m3U6u7o7uHOSYbWh9fTfsPLLHJq0qsGytcwg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_png/MpgDHibvMpokR1ZW26weXib2E2SbhhhmTE8gxO6cMw7V0PKG9xANIqlNm44MF8ej3lIRn4ID4LWe4OyXOoGxUpyQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
与此同时，骨干路由器还有一`种ACL Based Forwarding (ABF)`的匹配规则，可以在全国骨干路由器同步步数ip端口封锁规则，由于理解不太深入，这里不做专门介绍。
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_jpg/MpgDHibvMpok9ZQI2iayBUvcnibk9eYKvJibF2txz3gCJbZDFrzHVn3YzDe0TZULD15YOFsIJXsqmQiah4Y1ibdicQjAQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_png/MpgDHibvMpok9ZQI2iayBUvcnibk9eYKvJibicLeNBricq46QPGLaQ7mnPXkica32v0yehvBAE2UN31EvwJqcXOyhb2ibA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1 "图片")
...
![图片](https://images.weserv.nl/?url=https://mmbiz.qpic.cn/mmbiz_jpg/MpgDHibvMpokR1ZW26weXib2E2SbhhhmTEbnFZptPwTwBcHt0gf9UbIoIyY10Np8NcNOWlTrNQcUPtnvjYj2dQZA/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1 "图片")



## 原文

<iframe src=https://www.bilibili.com/read/cv20691224/?jump_opus=1 width="100%" height="480" frameborder="0">